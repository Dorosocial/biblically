...
// Full-screen centered stacked bold caps text for standalone callout
// moments — no shake support (this composition never shakes).
export const BigText: React.FC<{lines: BigTextLine[]; top?: number}> = ({lines, top}) => {
  return (
    <div
      style={{
        position: 'absolute',

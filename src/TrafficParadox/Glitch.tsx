...
// Fixed, predictable per-bar opacity cap (no multiplicative trig stacking)
// so the peak brightness is easy to reason about and verify.
const BAR_OPACITY = [0.22, 0.13, 0.09];

// A brief deterministic glitch/flash — no Math.random(), just a frame-
// seeded sine for horizontal jitter only (never for opacity), so the
// peak intensity is always known and bounded. Signals a tone shift.

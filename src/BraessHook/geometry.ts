// Pure geometry: node positions, road curves, and route sampling for
// car-dots. World space matches the final canvas 1:1 (1080 x 1920) so a
// "scale=1" camera shows the whole network without any transform.
